...
void isr_install() {
    set_int(0, (uint32)isr0);
    set_int(1, (uint32)isr1);
    set_int(2, (uint32)isr2);
    set_int(3, (uint32)isr3);
    set_int(4, (uint32)isr4);
    set_int(5, (uint32)isr5);
    set_int(6, (uint32)isr6);
    set_int(7, (uint32)isr7);
    set_int(8, (uint32)isr8);
    set_int(9, (uint32)isr9);
    set_int(10, (uint32)isr10);
    set_int(11, (uint32)isr11);
    set_int(12, (uint32)isr12);
    set_int(13, (uint32)isr13);
    set_int(14, (uint32)isr14);
    set_int(15, (uint32)isr15);
    set_int(16, (uint32)isr16);
    set_int(17, (uint32)isr17);
    set_int(18, (uint32)isr18);
    set_int(19, (uint32)isr19);
    set_int(20, (uint32)isr20);
    set_int(21, (uint32)isr21);
    set_int(22, (uint32)isr22);
    set_int(23, (uint32)isr23);
    set_int(24, (uint32)isr24);
    set_int(25, (uint32)isr25);
    set_int(26, (uint32)isr26);
    set_int(27, (uint32)isr27);
    set_int(28, (uint32)isr28);
    set_int(29, (uint32)isr29);
    set_int(30, (uint32)isr30);
    set_int(31, (uint32)isr31);
