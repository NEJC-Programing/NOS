...
extern void* mem_allocate(duint16_t size, duint16_t flags);
extern void p();
extern void v();
...
#ifndef THREAD_LOCK
#define THREAD_LOCK() p()
#endif

#ifndef THREAD_UNLOCK
#define THREAD_UNLOCK() v()
#endif
...
malloc_init (void)
{
    ...
    malloc_origo = ((duint16_t) page_dir >> malloc_pageshift) - malloc_pageshift;
